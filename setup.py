...
required = [f"ocp-linux-386 >= {VERSION}; platform_system=='Linux' and platform_machine=='i386'",
            ...
            f"ocp-windows-386 >= {VERSION}; platform_system=='Windows' and platform_machine=='i386'",
            f"ocp-windows-amd64 >= {VERSION}; platform_system=='Windows' and platform_machine=='x86_64'",
